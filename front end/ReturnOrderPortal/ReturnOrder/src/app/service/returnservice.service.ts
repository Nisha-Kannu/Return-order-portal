...
export class ReturnserviceService {
  ...
  readonly baseUrl = 'http://20.232.73.138/api/UserLogin';
  readonly baseUrl1 = 'http://20.232.73.138/api/ReturnOrder/GetDetails';
  readonly cprocess = "http://20.232.73.138/api/ReturnOrder/CompleteProcessing?flag="
